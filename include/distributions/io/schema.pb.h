...
inline ::google::protobuf::uint64 Clustering_LowEntropy::dataset_size() const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.Clustering.LowEntropy.dataset_size)
  return dataset_size_;
}
inline void Clustering_LowEntropy::set_dataset_size(::google::protobuf::uint64 value) {
  set_has_dataset_size();
  dataset_size_ = value;
  // @@protoc_insertion_point(field_set:protobuf.distributions.Clustering.LowEntropy.dataset_size)
}
...
inline const ::protobuf::distributions::Clustering_PitmanYor& Clustering::pitman_yor() const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.Clustering.pitman_yor)
...
inline ::protobuf::distributions::Clustering_PitmanYor* Clustering::mutable_pitman_yor() {
  ...
  // @@protoc_insertion_point(field_mutable:protobuf.distributions.Clustering.pitman_yor)
  return pitman_yor_;
}
...
inline void Clustering::set_allocated_pitman_yor(::protobuf::distributions::Clustering_PitmanYor* pitman_yor) {
  ...
  // @@protoc_insertion_point(field_set_allocated:protobuf.distributions.Clustering.pitman_yor)
}
...
inline const ::protobuf::distributions::Clustering_LowEntropy& Clustering::low_entropy() const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.Clustering.low_entropy)
...
inline ::protobuf::distributions::Clustering_LowEntropy* Clustering::mutable_low_entropy() {
  ...
  // @@protoc_insertion_point(field_mutable:protobuf.distributions.Clustering.low_entropy)
  return low_entropy_;
}
...
inline void Clustering::set_allocated_low_entropy(::protobuf::distributions::Clustering_LowEntropy* low_entropy) {
  ...
  // @@protoc_insertion_point(field_set_allocated:protobuf.distributions.Clustering.low_entropy)
}
...
inline ::google::protobuf::uint64 DirichletProcessDiscrete_Shared::counts(int index) const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.DirichletProcessDiscrete.Shared.counts)
  return counts_.Get(index);
}
inline void DirichletProcessDiscrete_Shared::set_counts(int index, ::google::protobuf::uint64 value) {
  counts_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf.distributions.DirichletProcessDiscrete.Shared.counts)
}
inline void DirichletProcessDiscrete_Shared::add_counts(::google::protobuf::uint64 value) {
  counts_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf.distributions.DirichletProcessDiscrete.Shared.counts)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >&
DirichletProcessDiscrete_Shared::counts() const {
  // @@protoc_insertion_point(field_list:protobuf.distributions.DirichletProcessDiscrete.Shared.counts)
  return counts_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >*
DirichletProcessDiscrete_Shared::mutable_counts() {
  // @@protoc_insertion_point(field_mutable_list:protobuf.distributions.DirichletProcessDiscrete.Shared.counts)
  return &counts_;
}
...
inline float PitmanYorProcessDiscrete_Shared::alpha() const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.PitmanYorProcessDiscrete.Shared.alpha)
  return alpha_;
}
inline void PitmanYorProcessDiscrete_Shared::set_alpha(float value) {
  set_has_alpha();
  alpha_ = value;
  // @@protoc_insertion_point(field_set:protobuf.distributions.PitmanYorProcessDiscrete.Shared.alpha)
}
...
inline float PitmanYorProcessDiscrete_Shared::d(int index) const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.PitmanYorProcessDiscrete.Shared.d)
  return d_.Get(index);
}
inline void PitmanYorProcessDiscrete_Shared::set_d(int index, float value) {
  d_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf.distributions.PitmanYorProcessDiscrete.Shared.d)
}
inline void PitmanYorProcessDiscrete_Shared::add_d(float value) {
  d_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf.distributions.PitmanYorProcessDiscrete.Shared.d)
}
inline const ::google::protobuf::RepeatedField< float >&
PitmanYorProcessDiscrete_Shared::d() const {
  // @@protoc_insertion_point(field_list:protobuf.distributions.PitmanYorProcessDiscrete.Shared.d)
  return d_;
}
inline ::google::protobuf::RepeatedField< float >*
PitmanYorProcessDiscrete_Shared::mutable_d() {
  // @@protoc_insertion_point(field_mutable_list:protobuf.distributions.PitmanYorProcessDiscrete.Shared.d)
  return &d_;
}
...
inline ::google::protobuf::uint64 PitmanYorProcessDiscrete_Shared::counts(int index) const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.PitmanYorProcessDiscrete.Shared.counts)
  return counts_.Get(index);
}
inline void PitmanYorProcessDiscrete_Shared::set_counts(int index, ::google::protobuf::uint64 value) {
  counts_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf.distributions.PitmanYorProcessDiscrete.Shared.counts)
}
inline void PitmanYorProcessDiscrete_Shared::add_counts(::google::protobuf::uint64 value) {
  counts_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf.distributions.PitmanYorProcessDiscrete.Shared.counts)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >&
PitmanYorProcessDiscrete_Shared::counts() const {
  // @@protoc_insertion_point(field_list:protobuf.distributions.PitmanYorProcessDiscrete.Shared.counts)
  return counts_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >*
PitmanYorProcessDiscrete_Shared::mutable_counts() {
  // @@protoc_insertion_point(field_mutable_list:protobuf.distributions.PitmanYorProcessDiscrete.Shared.counts)
  return &counts_;
}
...
inline ::google::protobuf::uint32 PitmanYorProcessDiscrete_Group::keys(int index) const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.PitmanYorProcessDiscrete.Group.keys)
  return keys_.Get(index);
}
inline void PitmanYorProcessDiscrete_Group::set_keys(int index, ::google::protobuf::uint32 value) {
  keys_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf.distributions.PitmanYorProcessDiscrete.Group.keys)
}
inline void PitmanYorProcessDiscrete_Group::add_keys(::google::protobuf::uint32 value) {
  keys_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf.distributions.PitmanYorProcessDiscrete.Group.keys)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
PitmanYorProcessDiscrete_Group::keys() const {
  // @@protoc_insertion_point(field_list:protobuf.distributions.PitmanYorProcessDiscrete.Group.keys)
  return keys_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
PitmanYorProcessDiscrete_Group::mutable_keys() {
  // @@protoc_insertion_point(field_mutable_list:protobuf.distributions.PitmanYorProcessDiscrete.Group.keys)
  return &keys_;
}
...
inline ::google::protobuf::uint64 PitmanYorProcessDiscrete_Group::values(int index) const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.PitmanYorProcessDiscrete.Group.values)
  return values_.Get(index);
}
inline void PitmanYorProcessDiscrete_Group::set_values(int index, ::google::protobuf::uint64 value) {
  values_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf.distributions.PitmanYorProcessDiscrete.Group.values)
}
inline void PitmanYorProcessDiscrete_Group::add_values(::google::protobuf::uint64 value) {
  values_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf.distributions.PitmanYorProcessDiscrete.Group.values)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >&
PitmanYorProcessDiscrete_Group::values() const {
  // @@protoc_insertion_point(field_list:protobuf.distributions.PitmanYorProcessDiscrete.Group.values)
  return values_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >*
PitmanYorProcessDiscrete_Group::mutable_values() {
  // @@protoc_insertion_point(field_mutable_list:protobuf.distributions.PitmanYorProcessDiscrete.Group.values)
  return &values_;
}
...
inline ::google::protobuf::uint64 BetaNegativeBinomial_Group::sum() const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.BetaNegativeBinomial.Group.sum)
  return sum_;
}
inline void BetaNegativeBinomial_Group::set_sum(::google::protobuf::uint64 value) {
  set_has_sum();
  sum_ = value;
  // @@protoc_insertion_point(field_set:protobuf.distributions.BetaNegativeBinomial.Group.sum)
}
...
inline float NormalInverseWishart_Shared::mu(int index) const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.NormalInverseWishart.Shared.mu)
  return mu_.Get(index);
}
inline void NormalInverseWishart_Shared::set_mu(int index, float value) {
  mu_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf.distributions.NormalInverseWishart.Shared.mu)
}
inline void NormalInverseWishart_Shared::add_mu(float value) {
  mu_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf.distributions.NormalInverseWishart.Shared.mu)
}
inline const ::google::protobuf::RepeatedField< float >&
NormalInverseWishart_Shared::mu() const {
  // @@protoc_insertion_point(field_list:protobuf.distributions.NormalInverseWishart.Shared.mu)
  return mu_;
}
inline ::google::protobuf::RepeatedField< float >*
NormalInverseWishart_Shared::mutable_mu() {
  // @@protoc_insertion_point(field_mutable_list:protobuf.distributions.NormalInverseWishart.Shared.mu)
  return &mu_;
}
...
inline float NormalInverseWishart_Shared::kappa() const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.NormalInverseWishart.Shared.kappa)
  return kappa_;
}
inline void NormalInverseWishart_Shared::set_kappa(float value) {
  set_has_kappa();
  kappa_ = value;
  // @@protoc_insertion_point(field_set:protobuf.distributions.NormalInverseWishart.Shared.kappa)
}
...
inline float NormalInverseWishart_Shared::psi(int index) const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.NormalInverseWishart.Shared.psi)
  return psi_.Get(index);
}
inline void NormalInverseWishart_Shared::set_psi(int index, float value) {
  psi_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf.distributions.NormalInverseWishart.Shared.psi)
}
inline void NormalInverseWishart_Shared::add_psi(float value) {
  psi_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf.distributions.NormalInverseWishart.Shared.psi)
}
inline const ::google::protobuf::RepeatedField< float >&
NormalInverseWishart_Shared::psi() const {
  // @@protoc_insertion_point(field_list:protobuf.distributions.NormalInverseWishart.Shared.psi)
  return psi_;
}
inline ::google::protobuf::RepeatedField< float >*
NormalInverseWishart_Shared::mutable_psi() {
  // @@protoc_insertion_point(field_mutable_list:protobuf.distributions.NormalInverseWishart.Shared.psi)
  return &psi_;
}
...
inline float NormalInverseWishart_Shared::nu() const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.NormalInverseWishart.Shared.nu)
  return nu_;
}
inline void NormalInverseWishart_Shared::set_nu(float value) {
  set_has_nu();
  nu_ = value;
  // @@protoc_insertion_point(field_set:protobuf.distributions.NormalInverseWishart.Shared.nu)
}
...
inline ::google::protobuf::int32 NormalInverseWishart_Group::count() const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.NormalInverseWishart.Group.count)
  return count_;
}
inline void NormalInverseWishart_Group::set_count(::google::protobuf::int32 value) {
  set_has_count();
  count_ = value;
  // @@protoc_insertion_point(field_set:protobuf.distributions.NormalInverseWishart.Group.count)
}
...
inline float NormalInverseWishart_Group::sum_x(int index) const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.NormalInverseWishart.Group.sum_x)
  return sum_x_.Get(index);
}
inline void NormalInverseWishart_Group::set_sum_x(int index, float value) {
  sum_x_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf.distributions.NormalInverseWishart.Group.sum_x)
}
inline void NormalInverseWishart_Group::add_sum_x(float value) {
  sum_x_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf.distributions.NormalInverseWishart.Group.sum_x)
}
inline const ::google::protobuf::RepeatedField< float >&
NormalInverseWishart_Group::sum_x() const {
  // @@protoc_insertion_point(field_list:protobuf.distributions.NormalInverseWishart.Group.sum_x)
  return sum_x_;
}
inline ::google::protobuf::RepeatedField< float >*
NormalInverseWishart_Group::mutable_sum_x() {
  // @@protoc_insertion_point(field_mutable_list:protobuf.distributions.NormalInverseWishart.Group.sum_x)
  return &sum_x_;
}
...
inline float NormalInverseWishart_Group::sum_xxt(int index) const {
  // @@protoc_insertion_point(field_get:protobuf.distributions.NormalInverseWishart.Group.sum_xxT)
...
inline void NormalInverseWishart_Group::set_sum_xxt(int index, float value) {
  ...
  // @@protoc_insertion_point(field_set:protobuf.distributions.NormalInverseWishart.Group.sum_xxT)
}
inline void NormalInverseWishart_Group::add_sum_xxt(float value) {
  sum_xxt_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf.distributions.NormalInverseWishart.Group.sum_xxT)
}
inline const ::google::protobuf::RepeatedField< float >&
NormalInverseWishart_Group::sum_xxt() const {
  // @@protoc_insertion_point(field_list:protobuf.distributions.NormalInverseWishart.Group.sum_xxT)
  return sum_xxt_;
}
inline ::google::protobuf::RepeatedField< float >*
NormalInverseWishart_Group::mutable_sum_xxt() {
  // @@protoc_insertion_point(field_mutable_list:protobuf.distributions.NormalInverseWishart.Group.sum_xxT)
  return &sum_xxt_;
}
